...
ROLE_CONTEXT = {
    "voter": "The user is a voter (possibly first-time). Focus on registration, polling booth location, ID required, how to vote, what to expect on voting day. Be encouraging and break processes into simple steps.",
    "candidate": "The user is a candidate or interested in standing for election. Focus on nomination, eligibility criteria, campaign rules, spending limits, code of conduct. Be precise about legal requirements.",
    "journalist": "The user is a journalist or researcher. Focus on electoral regulations, campaign finance laws, media guidelines, exit poll rules. Provide detailed, well-sourced answers.",
    "student": "The user is a student learning civics. Use analogies, keep it simple, make it engaging and educational. Use examples and comparisons to explain complex concepts."
}
...
def get_suggested_questions(role: str) -> list:
    """Get suggested questions for a given role."""
    role_key = role.lower() if role else "voter"
